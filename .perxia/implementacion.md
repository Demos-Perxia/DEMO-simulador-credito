...
- Pendiente: la ejecución de `npm test` requiere un binario ChromeHeadless que no está instalado y falta recorrido E2E completo. La API se compiló y validó con .NET 10 disponible localmente.
